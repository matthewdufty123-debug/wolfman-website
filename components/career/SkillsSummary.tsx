      ...
      {skills.map(skill => {
        ...
        return (
          <div key={`${skill.name}-${skill.source}`} className="career-skill-card">
            {/* Skill name */}
            <p className="font-[family-name:var(--font-inter)] font-semibold text-sm mb-3"
            ...
            <div className="flex flex-wrap items-center gap-2 mb-4">
              <span
                className="font-[family-name:var(--font-jetbrains)] text-[10px] font-bold uppercase tracking-widest px-2.5 py-1 rounded"
                style={{ color: tc.hex, background: tc.bg }}
              >
                {tc.short}
              </span>
              <span
                className="font-[family-name:var(--font-jetbrains)] text-[10px] font-medium uppercase tracking-wider px-2.5 py-1 rounded"
                style={{
            ...
            {skill.wolfbotComment && (
              <p className="font-[family-name:var(--font-jetbrains)] text-[11px] mt-3 italic text-[#A0622A]"
                 style={{ opacity: 0.7 }}>
                {skill.wolfbotComment}
              </p>
            )}
